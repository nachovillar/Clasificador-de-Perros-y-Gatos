# -*- coding: utf-8 -*-
"""
Created on Sun Feb  6 14:04:21 2022
...
training_dataset = train_datagen.flow_from_directory( #Cargamos una carpeta de trabajo con las imágenes para entrenar
        ...
        target_size=(64, 64), #Tamaño en el que espero cargar las imágenes, y como en la convolución esperamos que salgan de 64x64, colocamos esto
        ...
        class_mode='binary') #como tengo 2 categorías, entonces es binario. Si tuviera una clasificación > 2, habría que cambiarlo
...
results = classifier.fit_generator( #Hacer el ajuste a nuestro modelo(clasificador)
        ...
        epochs=30, #Cantidad de épocas, es decir, la cantidad de veces que pasará el conjunto de entrenamiento por la red
